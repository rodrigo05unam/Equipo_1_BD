...
-- ENTIDAD: ORDEN
-- total_pagar se guarda aunque sea derivado
...
-- ORDEN - PRODUCTO
-- subtotal_prod se guarda aunque sea derivado
...
-- RELACIÓN M:M PAGA
-- ORDEN - CLIENTE
-- monto_pago se guarda aunque sea derivado
