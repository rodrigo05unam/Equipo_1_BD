...
/* ============================================================
   9) DETALLE_ORDEN
   subtotal_prod = cantidad * precio del producto.
   ============================================================ */

INSERT INTO detalle_orden (folio, id_producto, cant_prod, subtotal_prod) VALUES
(1001, 1, 1, 295.00), (1001, 8, 2, 390.00), (1001, 25, 2, 116.00),
(1002, 6, 1, 215.00), (1002, 4, 1, 199.00), (1002, 30, 2, 138.00),
(1003, 16, 1, 425.00), (1003, 23, 1, 209.00), (1003, 31, 2, 350.00),
(1004, 17, 1, 445.00), (1004, 18, 1, 385.00), (1004, 35, 2, 250.00),
(1005, 12, 2, 518.00), (1005, 9, 1, 159.00), (1005, 28, 2, 194.00),
(1006, 21, 1, 415.00), (1006, 5, 1, 299.00), (1006, 33, 3, 237.00),
(1007, 19, 2, 460.00), (1007, 22, 2, 338.00), (1007, 26, 2, 130.00),
(1008, 15, 1, 365.00), (1008, 11, 1, 225.00), (1008, 36, 2, 418.00),
(1009, 7, 1, 305.00), (1009, 3, 1, 230.00), (1009, 32, 3, 315.00),
(1010, 20, 1, 254.00), (1010, 14, 1, 295.00), (1010, 24, 1, 199.00), (1010, 27, 2, 96.00),
(1011, 13, 2, 530.00), (1011, 2, 1, 299.00), (1011, 34, 4, 268.00),
(1012, 18, 2, 770.00), (1012, 31, 2, 350.00), (1012, 23, 2, 418.00),
(1013, 10, 3, 477.00), (1013, 29, 2, 164.00), (1013, 22, 1, 169.00),
(1014, 16, 2, 850.00), (1014, 21, 1, 415.00), (1014, 35, 3, 375.00),
(1015, 17, 1, 445.00), (1015, 15, 1, 365.00), (1015, 24, 2, 398.00), (1015, 33, 2, 158.00);

-- Actualiza total_pagar con base en detalle_orden.
UPDATE orden o
SET total_pagar = COALESCE((
    SELECT SUM(d.subtotal_prod)
    FROM detalle_orden d
    WHERE d.folio = o.folio
), 0);
